...
const func: DeployFunction = async function(hre: HardhatRuntimeEnvironment) {
    ...
    await (await MonaUpgrades.mint("ipfs://bafyreicbprxw53ixuzib5v4gq2f52qyauvgg77djmbmr6ipjuiprgoh6tq/metadata.json")).wait(); // spok
    await (await MonaUpgrades.mint("ipfs://bafyreieqczh4tmcvcozktxfbdskacwm2jfvfqwxavtuyc5sufifxxjzhzm/metadata.json")).wait(); // just
    ...
    await (await MonaUpgrades.mint("ipfs://bafyreiemct4v4hzh42tfhmryrgda7rl3uq7ymgqlcoepunwdsfjty5ywxu/metadata.json")).wait(); // patrick
